...
Internal components (Encoder, EncoderLayer, MultiHeadedAttention,
PositionwiseFeedForward, Embeddings, LayerNorm, ScaleNorm, attention) are
carried over verbatim from OldCode/cpmp/model/transformer.py.
"""
...
# ---------------------------------------------------------------------------
# Internal components (verbatim from OldCode/cpmp/model/transformer.py)
# ---------------------------------------------------------------------------
