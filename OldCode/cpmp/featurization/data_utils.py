...
def load_data_from_df(
    ...
    Args:
        ...
        ff (str): Force field: uff or mmff.
        ignoreInterfragInteractions (bool): True or False.
    ...
    """
    feat_stamp = (
        f'{"_dn" if add_dummy_node else ""}{"_ohfc" if one_hot_formal_charge else ""}'
    )
            ...
            try:
                ...
                if ff == "uff":
                    AllChem.UFFOptimizeMolecule(
                        mol, ignoreInterfragInteractions=ignoreInterfragInteractions
                    )
                else:
