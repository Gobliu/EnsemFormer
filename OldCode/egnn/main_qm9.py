...
def train(epoch, loader, partition='train'):
    ...
    for i, data in enumerate(loader):
        ...
        print(data.keys())
        print(data['num_atoms'].shape, data['charges'].shape, data['positions'].shape)
        print(data['edge_mask'].shape, torch.sum(data['edge_mask']))
        print(data['atom_mask'].shape, torch.sum(data['atom_mask']))
        print(data['A'].shape, data['A'])
        quit()
